...
import static com.metrogenesis.minecolonies.api.util.constant.TranslationConstants.TOWNHALL_BREAKING_DONE_MESSAGE;
import static com.metrogenesis.minecolonies.api.util.constant.TranslationConstants.WARNING_DUPLICATE_TOWN_HALL;
...
public class BlockHutTownHall extends AbstractBlockHut<BlockHutTownHall>
{
    ...
    public List<MutableComponent> getRequirements(final ClientLevel level, final BlockPos pos, final LocalPlayer player)
    {
        ...
        {
            requirements.add(Component.translatable("com.metrogenesis.minecolonies.coremod.hut.cost", Component.translatable("block." + Constants.MOD_ID + "." + getHutName())).setStyle((Style.EMPTY).withColor(
              ChatFormatting.RED)));
        }
