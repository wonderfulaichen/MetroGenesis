...
import com.metrogenesis.structurize.util.BlueprintPositionInfo;
...
import com.metrogenesis.minecolonies.core.colony.buildings.modules.BuildingResourcesModule;
import com.metrogenesis.minecolonies.core.colony.buildings.utils.BuilderBucket;
...
import static com.metrogenesis.minecolonies.api.research.util.ResearchConstants.BLOCK_PLACE_SPEED;
...
import static com.metrogenesis.minecolonies.core.entity.ai.workers.AbstractEntityAIStructure.ItemCheckResult.*;
import static com.metrogenesis.minecolonies.core.entity.ai.workers.util.BuildingProgressStage.*;
...
public abstract class AbstractEntityAIStructure<J extends AbstractJobStructure<?, J>, B extends AbstractBuildingStructureBuilder> extends AbstractEntityAIInteract<J, B>
{
    ...
    {
        if (info.getBlockInfo().getState().getBlock() == com.metrogenesis.structurize.blocks.ModBlocks.blockFluidSubstitution.get())
        {
            return true;
        }
    ...
    private boolean skipRemoval(final BlueprintPositionInfo info, final BlockPos pos, final IStructureHandler handler)
    {
        ...
        if (infoBlockState.isAir()
              || infoBlock == com.metrogenesis.structurize.blocks.ModBlocks.blockSolidSubstitution.get()
              || infoBlock == com.metrogenesis.structurize.blocks.ModBlocks.blockSubstitution.get()
              || infoBlock == com.metrogenesis.structurize.blocks.ModBlocks.blockFluidSubstitution.get())
        {
            return true;
        }
