...
import com.metrogenesis.minecolonies.core.colony.buildings.workerbuildings.BuildingComposter;
import com.metrogenesis.minecolonies.core.colony.jobs.JobComposter;
import com.metrogenesis.minecolonies.core.entity.ai.workers.AbstractEntityAIInteract;
import com.metrogenesis.minecolonies.core.tileentities.TileEntityBarrel;
...
import static com.metrogenesis.minecolonies.api.research.util.ResearchConstants.PODZOL_CHANCE;
import static com.metrogenesis.minecolonies.api.util.constant.Constants.DOUBLE;
import static com.metrogenesis.minecolonies.api.util.constant.Constants.TICKS_SECOND;
import static com.metrogenesis.minecolonies.api.util.constant.TranslationConstants.COM_MINECOLONIES_COREMOD_ENTITY_COMPOSTER_EMPTYLIST;
import static com.metrogenesis.minecolonies.api.util.constant.StatisticsConstants.ITEMS_COMPOSTED;
import static com.metrogenesis.minecolonies.api.util.constant.StatisticsConstants.PRODUCT_COLLECTED;
...
public class EntityAIWorkComposter extends AbstractEntityAIInteract<JobComposter, BuildingComposter>
{
    ...
    private final static VisibleCitizenStatus COMPOST =
      new VisibleCitizenStatus(new ResourceLocation(Constants.MOD_ID, "textures/icons/work/composter.png"), "com.metrogenesis.minecolonies.gui.visiblestatus.composter");
