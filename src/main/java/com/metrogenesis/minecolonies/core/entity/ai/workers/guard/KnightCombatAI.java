...
import com.metrogenesis.minecolonies.api.compatibility.tinkers.TinkersToolHelper;
...
public class KnightCombatAI extends AttackMoveAI<EntityCitizen>
{
    ...
    private final static VisibleCitizenStatus KNIGHT_COMBAT =
      new VisibleCitizenStatus(new ResourceLocation(Constants.MOD_ID, "textures/icons/work/knight_combat.png"), "com.metrogenesis.minecolonies.gui.visiblestatus.knight_combat");
