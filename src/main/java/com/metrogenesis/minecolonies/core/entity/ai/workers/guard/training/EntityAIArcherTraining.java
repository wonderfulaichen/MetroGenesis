package com.metrogenesis.minecolonies.core.entity.ai.workers.guard.training;
...
import com.metrogenesis.minecolonies.core.colony.buildings.workerbuildings.BuildingArchery;
import com.metrogenesis.minecolonies.core.colony.jobs.JobArcherTraining;
...
import static com.metrogenesis.minecolonies.api.util.constant.StatisticsConstants.ARROWS_FIRED;
import static com.metrogenesis.minecolonies.api.util.constant.StatisticsConstants.ARROWS_HIT;
import static com.metrogenesis.minecolonies.api.util.constant.StatisticsConstants.LEVELS_GAINED;
...
public class EntityAIArcherTraining extends AbstractEntityAITraining<JobArcherTraining, BuildingArchery>
{
    ...
    private final static VisibleCitizenStatus ARCHER_TRAIN =
      new VisibleCitizenStatus(new ResourceLocation(Constants.MOD_ID, "textures/icons/work/archer_uni.png"), "com.metrogenesis.minecolonies.gui.visiblestatus.archer_uni");
