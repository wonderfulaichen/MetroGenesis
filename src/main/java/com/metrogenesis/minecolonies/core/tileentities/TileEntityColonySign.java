...
import com.metrogenesis.minecolonies.api.colony.connections.ColonyConnectionNode;
...
public class TileEntityColonySign extends BlockEntity implements ITickable
{
    ...
    private void calculateRotation(final BlockPos previousNode)
    {
        ...
        double angleRad = Math.atan2(-dz, dx);  // East = 0掳, North = 90掳, West = 180掳, South = 270掳
