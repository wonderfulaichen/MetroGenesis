...
public class PlaceBlockObjectiveTemplate extends DialogueObjectiveTemplateTemplate implements IPlaceBlockObjectiveTemplate
{
    ...
    {
        final Component text = Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.placeblock", blockToMine.getName());
    ...
    public Component getProgressText(final IQuestInstance quest, final Style style)
    {
        ...
        {
            return Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.placeblock.progress",
