...
public class ResearchObjectiveTemplate extends DialogueObjectiveTemplateTemplate implements IResearchObjectiveTemplate
{
    ...
    private static DialogueElement buildDialogueTree(final ResourceLocation researchId)
    {
        ...
        final Component text  = Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.research", MutableComponent.create((research.getName())));
    ...
    public Component getProgressText(final IQuestInstance quest, final Style style)
    {
        ...
        return Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.research.progress", MutableComponent.create(research.getName()));
    }
