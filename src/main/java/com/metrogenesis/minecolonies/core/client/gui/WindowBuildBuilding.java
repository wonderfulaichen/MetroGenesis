...
import com.metrogenesis.minecolonies.api.util.LoadOnlyStructureHandler;
...
import com.metrogenesis.minecolonies.core.network.messages.server.colony.building.BuildPickUpMessage;
import com.metrogenesis.minecolonies.core.network.messages.server.colony.building.BuildRequestMessage;
import com.metrogenesis.minecolonies.core.network.messages.server.colony.building.BuildingSetStyleMessage;
...
import static com.metrogenesis.minecolonies.api.util.constant.TranslationConstants.ACTION_BUILD;
import static com.metrogenesis.minecolonies.api.util.constant.TranslationConstants.ACTION_UPGRADE;
...
public class WindowBuildBuilding extends AbstractWindowSkeleton
{
    ...
    public WindowBuildBuilding(final IColonyView c, final IBuildingView building)
    {
        ...
        {
            buttonBuild.setText(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.workerhuts.build"));
    ...
    private void confirmClicked()
    {
        ...
        {
            new WindowConfirm(this, () -> triggerConfirmAction(builder), "com.metrogenesis.minecolonies.core.gui.build.confirm.title", building.getHoverWarningForLevel()).open();
            return;
        }
