...
import com.metrogenesis.minecolonies.core.colony.buildings.moduleviews.DOCraftingModuleView;
...
import static com.metrogenesis.minecolonies.api.util.constant.TranslationConstants.DOCRAFTING_BLOCK;
...
public class DOCraftingWindow extends AbstractModuleWindow<DOCraftingModuleView>
{
    ...
    private void addRecipe()
    {
        ...
        final IRecipeStorage storage = RecipeStorage.builder()
                ...
                .withGridSize(3)
                .withRecipeType(com.metrogenesis.minecolonies.api.crafting.ModRecipeTypes.MULTI_OUTPUT_ID)
                .build();
