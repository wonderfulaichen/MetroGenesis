...
import com.metrogenesis.minecolonies.core.client.gui.WindowResearchTree;
import com.metrogenesis.minecolonies.core.colony.buildings.moduleviews.UniversityResearchModuleView;
...
import static com.metrogenesis.minecolonies.api.research.util.ResearchConstants.COLOR_TEXT_UNFULFILLED;
import static com.metrogenesis.minecolonies.api.util.constant.WindowConstants.GUI_LIST_ELEMENT_NAME;
import static com.metrogenesis.minecolonies.api.util.constant.WindowConstants.UNI_INV_RESEARCH;
/**
...
public class UniversityModuleWindow extends AbstractModuleWindow<UniversityResearchModuleView>
{
    ...
    public List<MutableComponent> getHidingRequirementDesc(final ResourceLocation branch)
    {
        ...
        for(final ResourceLocation primary : IGlobalResearchTree.getInstance().getPrimaryResearch(branch))
        {
            ...
            else
            {
                ...
                {
                    requirements.add(Component.translatable("com.metrogenesis.minecolonies.coremod.research.locked"));
                }
                else
                {
    ...
    public void updateResearchCount(final int offset)
    {
        this.findPaneOfTypeByID("maxresearchwarn", Text.class)
          .setText(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.research.countinprogress",
