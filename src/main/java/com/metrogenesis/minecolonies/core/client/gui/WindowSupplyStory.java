...
import com.metrogenesis.minecolonies.core.event.ColonyStoryListener;
import com.metrogenesis.minecolonies.core.network.messages.server.MarkStoryReadOnItemMessage;
...
import static com.metrogenesis.minecolonies.api.items.ISupplyItem.SUPPLY_OFFSET_DISTANCE;
import static com.metrogenesis.minecolonies.api.util.constant.Constants.*;
import static com.metrogenesis.minecolonies.api.util.constant.NbtTagConstants.TAG_RANDOM_KEY;
...
public class WindowSupplyStory extends AbstractWindowSkeleton
{
    ...
    public WindowSupplyStory(final BlockPos pos, final String type, final ItemStack stack, final InteractionHand hand)
    {
        ...
        story.add(Component.translatable("com.metrogenesis.minecolonies.core.gui.supplies.guide", Component.translatable(stack.getItem().getDescriptionId())));
        story.add(Component.empty());

        if (stack.getItem() == ModItems.supplyCamp)
        {
            story.add(Component.translatable("com.metrogenesis.minecolonies.core.gui.supplycamp.guide"));
        }
        else
        {
            story.add(Component.translatable("com.metrogenesis.minecolonies.core.gui.supplyship.guide"));
        }

        this.findPaneOfTypeByID("text", Text.class).setText(story);
        this.findPaneOfTypeByID("place", Button.class).setText(Component.translatable("com.metrogenesis.minecolonies.core.gui.supplies.place", Component.translatable(stack.getItem().getDescriptionId())));
    }
