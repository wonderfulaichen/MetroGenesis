...
import static com.metrogenesis.minecolonies.api.util.constant.WindowConstants.LIST_SETTINGS;
        ...
        settingsList.setDataProvider(new ScrollingList.DataProvider()
        {
            ...
            public void updateElement(final int index, @NotNull final Pane rowPane)
            {
                ...
                if (box.getChildren().isEmpty())
                {
                    ...
                    {
                        rowDescriptionField.setText(Component.translatable("com.metrogenesis.minecolonies.coremod.setting." + key.getUniqueId().toString()));
                    }
                }
