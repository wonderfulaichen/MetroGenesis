...
import com.metrogenesis.minecolonies.api.colony.buildings.modules.IBuildingModule;
...
import com.metrogenesis.minecolonies.api.research.IGlobalResearch;
...
import com.metrogenesis.minecolonies.core.client.gui.WindowBuildingBrowser;
import com.metrogenesis.minecolonies.core.client.gui.containers.WindowCitizenInventory;
import com.metrogenesis.minecolonies.core.client.render.worldevent.ColonyBorderRenderer;
import com.metrogenesis.minecolonies.core.client.render.worldevent.WorldEventContext;
import com.metrogenesis.minecolonies.core.colony.crafting.CustomRecipe;
import com.metrogenesis.minecolonies.core.colony.crafting.CustomRecipeManager;
import com.metrogenesis.minecolonies.core.util.DomumOrnamentumUtils;
...
import static com.metrogenesis.minecolonies.api.research.util.ResearchConstants.SATURATION;
import static com.metrogenesis.minecolonies.api.sounds.ModSoundEvents.CITIZEN_SOUND_EVENT_PREFIX;
import static com.metrogenesis.minecolonies.api.util.constant.TranslationConstants.*;
import static com.metrogenesis.minecolonies.api.util.constant.translation.DebugTranslationConstants.*;
    ...
    public static void onItemTooltipEvent(final ItemTooltipEvent event)
    {
        ...
        if (stack.getItem() instanceof BlockItem)
        {
            ...
            if (event.getEntity().isCreative() && InventoryUtils.hasItemInItemHandler(new InvWrapper(event.getEntity().getInventory()), ModItems.scanTool.get()))
            {
                ...
                event.getToolTip().add(Component.translatable("com.metrogenesis.minecolonies.coremod.tooltip.schematic.tier", tier));
            }
        }
        ...
        if (WindowCitizenInventory.activeCitizenInventory != null && ItemStackUtils.ISFOOD.test(stack))
        {
            ...
            {
                event.getToolTip().add(Component.translatable("com.metrogenesis.minecolonies.coremod.item.tooltip.wrongfood").withStyle(ChatFormatting.RED));
                return;
            }
            ...
            if (FoodUtils.canEatLevel(event.getItemStack(), homeBuildingLevel))
            {
                ...
                {
                    event.getToolTip().add(Component.translatable("com.metrogenesis.minecolonies.coremod.item.tooltip.nomenu").withStyle(ChatFormatting.RED));
                }
            }
            else
            {
                event.getToolTip().add(Component.translatable("com.metrogenesis.minecolonies.coremod.item.tooltip.needbetterfood").withStyle(ChatFormatting.RED));
            }
        }
    }
