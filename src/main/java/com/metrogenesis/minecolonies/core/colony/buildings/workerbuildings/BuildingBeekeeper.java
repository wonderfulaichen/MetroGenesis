...
import com.metrogenesis.minecolonies.core.colony.buildings.modules.settings.BeekeeperCollectionSetting;
...
public class BuildingBeekeeper extends AbstractBuilding
{
    ...
    public static final ISettingKey<BeekeeperCollectionSetting> MODE =
      new SettingKey<>(BeekeeperCollectionSetting.class, new ResourceLocation(com.metrogenesis.minecolonies.api.util.constant.Constants.MOD_ID, "beekeeper"));

    /**
     * Both setting options.
     */
    public static final String HONEYCOMB = "com.metrogenesis.minecolonies.core.apiary.setting.honeycomb";
    public static final String HONEY     = "com.metrogenesis.minecolonies.core.apiary.setting.honey";
    public static final String BOTH      = "com.metrogenesis.minecolonies.core.apiary.setting.both";
