...
import com.metrogenesis.minecolonies.core.network.messages.server.colony.building.QuarryHiringModeMessage;
...
public class MinerAssignmentModuleView extends AbstractBuildingModuleView implements IAssignmentModuleView
{
    ...
    {
        return Component.translatable("com.metrogenesis.minecolonies.coremod.gui.workerhuts.quarry.miners");
    }
