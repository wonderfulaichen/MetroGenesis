...
import com.metrogenesis.structurize.placement.StructureIterators;
...
import static com.metrogenesis.minecolonies.api.research.util.ResearchConstants.BUILDER_MODE;
...
public class BuilderModeSetting extends StringSetting
{
     ...
     */
    public static final String NEEDS_RESEARCH_REASON  = "com.metrogenesis.minecolonies.coremod.settings.reason.needsresearch";
    public static final String BUILDER_MODES_RESEARCH = "com.metrogenesis.minecolonies.research.technology.buildermodes.name";
    ...
    {
        return Component.translatable("com.metrogenesis.structurize.iterators." + getSettings().get(getCurrentIndex()));
    }

    @Override
    public Component getToolTipText()
    {
        return Component.translatable("com.metrogenesis.structurize.iterators." + getSettings().get(getCurrentIndex()) + ".tooltip");
    }
