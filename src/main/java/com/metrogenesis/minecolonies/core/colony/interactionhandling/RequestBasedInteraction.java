...
import com.metrogenesis.minecolonies.api.colony.interactionhandling.*;
...
import static com.metrogenesis.minecolonies.core.colony.interactionhandling.StandardInteraction.*;
...
public class RequestBasedInteraction extends ServerCitizenInteraction
{
    ...
    private static final Tuple<Component, Component>[] tuples = (Tuple<Component, Component>[]) new Tuple[] {
      ...
      new Tuple<>(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.chat.cancel"), null),
      new Tuple<>(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.chat.fulfill"), null)};
    ...
    {
        if (((TranslatableContents) getPossibleResponses().get(responseId).getContents()).getKey().equals("com.metrogenesis.minecolonies.coremod.gui.chat.fulfill"))
        {
    ...
    public void onServerResponseTriggered(final int responseId, final Player player, final ICitizenData data)
    {
        ...
        if (response.equals(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.chat.cancel")) && data.getColony() != null)
        {
