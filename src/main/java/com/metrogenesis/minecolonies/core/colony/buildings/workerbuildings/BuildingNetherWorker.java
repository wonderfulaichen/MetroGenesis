...
import com.metrogenesis.minecolonies.core.colony.buildings.modules.MinimumStockModule;
...
public class BuildingNetherWorker extends AbstractBuilding
{
    ...
    public static final ISettingKey<BoolSetting> CLOSE_PORTAL =
        new SettingKey<>(BoolSetting.class, new ResourceLocation(com.metrogenesis.minecolonies.api.util.constant.Constants.MOD_ID, "closeportal"));
