...
import com.metrogenesis.minecolonies.api.colony.buildings.modules.IItemListModule;
...
import com.metrogenesis.minecolonies.core.colony.buildings.modules.AbstractCraftingBuildingModule;
...
import com.metrogenesis.minecolonies.core.colony.buildings.modules.settings.DynamicTreesSetting;
...
import static com.metrogenesis.minecolonies.api.util.constant.NbtTagConstants.TAG_NETHER_TREE_LIST;
import static com.metrogenesis.minecolonies.api.util.constant.EquipmentLevelConstants.TOOL_LEVEL_WOOD_OR_GOLD;
import static com.metrogenesis.minecolonies.core.entity.ai.workers.production.EntityAIWorkLumberjack.SAPLINGS_LIST;
...
public class BuildingLumberjack extends AbstractBuilding
{
     ...
     * Replant setting.
     */
    public static final ISettingKey<BoolSetting> REPLANT = new SettingKey<>(BoolSetting.class, new ResourceLocation(com.metrogenesis.minecolonies.api.util.constant.Constants.MOD_ID, "replant"));
    public static final ISettingKey<BoolSetting> RESTRICT = new SettingKey<>(BoolSetting.class, new ResourceLocation(com.metrogenesis.minecolonies.api.util.constant.Constants.MOD_ID, "restrict"));
    public static final ISettingKey<BoolSetting> DEFOLIATE = new SettingKey<>(BoolSetting.class, new ResourceLocation(com.metrogenesis.minecolonies.api.util.constant.Constants.MOD_ID, "defoliate"));
    public static final ISettingKey<DynamicTreesSetting> DYNAMIC_TREES_SIZE = new SettingKey<>(DynamicTreesSetting.class, new ResourceLocation(com.metrogenesis.minecolonies.api.util.constant.Constants.MOD_ID, "dynamictreeharvestsize"));
    ...
    public Map<Predicate<ItemStack>, Tuple<Integer, Boolean>> getRequiredItemsAndAmount()
    {
        ...
        for (final ItemStorage sapling : IColonyManager.getInstance().getCompatibilityManager().getCopyOfSaplings())
        {
            ...
            {
                toKeep.put(stack -> ItemStackUtils.compareItemStacksIgnoreStackSize(sapling.getItemStack(), stack), new Tuple<>(com.metrogenesis.minecolonies.api.util.constant.Constants.STACKSIZE, true));
            }
        }
        return toKeep;
    }
