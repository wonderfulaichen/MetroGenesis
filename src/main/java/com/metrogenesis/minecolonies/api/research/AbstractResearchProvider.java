package com.metrogenesis.minecolonies.api.research;
...
public abstract class AbstractResearchProvider implements DataProvider
{
    ...
    public static class ResearchBranch
    {
         ...
         * can have logic or colony ramifications.  See {@link com.metrogenesis.minecolonies.api.research.ResearchBranchType} for details.
