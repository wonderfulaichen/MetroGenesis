package com.metrogenesis.minecolonies.api.research.requirements;
...
import com.metrogenesis.minecolonies.api.research.IResearchRequirement;
...
import com.metrogenesis.minecolonies.core.util.GsonHelper;
...
import static com.metrogenesis.minecolonies.api.research.ModResearchRequirements.BUILDING_SINGLE_RESEARCH_REQ_ID;
import static com.metrogenesis.minecolonies.api.research.util.ResearchConstants.TAG_REQ_TYPE;
import static com.metrogenesis.minecolonies.core.datalistener.ResearchListener.RESEARCH_REQUIREMENT_TYPE_PROP;
...
public class BuildingResearchRequirement implements IResearchRequirement
{
    ...
    public MutableComponent getDesc()
    {
        ...
        if (singleBuilding)
        {
            return Component.translatable("com.metrogenesis.minecolonies.coremod.research.requirement.building.single.level", buildingName, buildingLevel);
        }
        else
        {
            return Component.translatable("com.metrogenesis.minecolonies.coremod.research.requirement.building.level", buildingName, buildingLevel);
        }
    }
