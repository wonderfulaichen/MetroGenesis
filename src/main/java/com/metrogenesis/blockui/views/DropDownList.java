...
import com.metrogenesis.blockui.util.records.Pos2i;
...
public class DropDownList extends View implements ButtonHandler
{
    ...
    public interface DataProvider
    {
        ...
        MutableComponent getLabel(final int index);

        default String getLabelString(final int index)
        {
            return getLabel(index).getString();
        }
    }
