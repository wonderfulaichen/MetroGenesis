package com.metrogenesis.blockui;

import com.metrogenesis.blockui.controls.AbstractTextBuilder.TooltipBuilder;
import com.metrogenesis.blockui.mod.BlockUI;
import com.metrogenesis.blockui.util.cursor.Cursor;
import com.metrogenesis.blockui.util.cursor.CursorUtils;
import com.metrogenesis.blockui.util.cursor.CursorUtils.StandardCursor;
...
public class Pane extends UiRenderMacros
{
    ...
    /**
     * Used mostly for overrides for default logics like {@link com.metrogenesis.blockui.views.ZoomDragView#getCursor ZoomDragView}
     */
