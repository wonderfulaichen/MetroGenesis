package com.metrogenesis.structurize.placement.structure;
...
public class CreativeStructureHandler extends AbstractStructureHandler
{
    ...
    {
        // 限制每 tick 放置方块数 — 1 块/tick，像殖民地那样一步步建造
        return Math.min(Structurize.getConfig().getServer().maxOperationsPerTick.get(), 1);
    }
