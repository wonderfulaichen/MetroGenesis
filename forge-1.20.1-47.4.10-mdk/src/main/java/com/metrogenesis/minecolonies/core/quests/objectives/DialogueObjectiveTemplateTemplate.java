...
import com.metrogenesis.minecolonies.api.quests.IDialogueObjectiveTemplate;
...
import static com.metrogenesis.minecolonies.api.quests.QuestParseConstant.TARGET_KEY;
import static com.metrogenesis.minecolonies.api.quests.QuestParseConstant.UNLOCKS_REWARDS_KEY;
...
public class DialogueObjectiveTemplateTemplate implements IDialogueObjectiveTemplate
{
    ...
    public Component getProgressText(final IQuestInstance quest, final Style style)
    {
        ...
        if (citizen != null)
        {
            return Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.answer.progress", citizen.getName()).setStyle(style);
        }
        else
        {
