...
import static com.metrogenesis.minecolonies.api.util.constant.GuardConstants.CAVALRY_DAMAGE_MULTIPLIER;
import static com.metrogenesis.minecolonies.api.util.constant.GuardConstants.CAVALRY_RANGE_MULTIPLIER;
...
public class CavalryCombatAI extends KnightCombatAI
{
    ...
    private final static VisibleCitizenStatus CAVALRY_COMBAT_ICON =
      new VisibleCitizenStatus(new ResourceLocation(Constants.MOD_ID, "textures/icons/work/cavalry_combat.png"), "com.metrogenesis.minecolonies.gui.visiblestatus.cavalry_combat");
