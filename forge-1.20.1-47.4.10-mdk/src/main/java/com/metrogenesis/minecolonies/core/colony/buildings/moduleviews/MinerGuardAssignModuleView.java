...
import com.metrogenesis.minecolonies.core.client.gui.modules.building.WindowMineGuardModule;
...
public class MinerGuardAssignModuleView extends AbstractBuildingModuleView
{
    ...
    {
        return Component.translatable("com.metrogenesis.minecolonies.coremod.gui.miner.guardassign");
    }
}
