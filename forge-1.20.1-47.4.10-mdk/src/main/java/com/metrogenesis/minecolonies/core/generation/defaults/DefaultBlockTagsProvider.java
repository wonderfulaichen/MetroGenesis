    ...
    protected void addTags(final HolderLookup.Provider holder)
    {
        ...
        tag(ModTags.pathingBlocks)
            ...
            .addTag(BlockTags.WOOL_CARPETS)
                ...
                .add(com.metrogenesis.domumornamentum.block.ModBlocks.getInstance().getAllBrickBlocks().toArray(new Block[0]))
                .add(com.metrogenesis.domumornamentum.block.ModBlocks.getInstance().getAllBrickStairBlocks().toArray(new Block[0]))
                .addTag(com.metrogenesis.domumornamentum.tag.ModTags.BRICKS);
        ...
        tag(com.metrogenesis.structurize.tag.ModTags.GOOD_SOLID_FOR_PLACEHOLDER).add(ModBlocks.farmland, ModBlocks.floodedFarmland);
    }
}
