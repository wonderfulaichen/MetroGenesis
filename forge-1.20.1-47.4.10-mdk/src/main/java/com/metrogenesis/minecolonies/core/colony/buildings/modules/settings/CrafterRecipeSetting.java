...
import static com.metrogenesis.minecolonies.api.research.util.ResearchConstants.RECIPE_MODE;
...
public class CrafterRecipeSetting extends StringSettingWithDesc
{
    ...
    public static final String WAREHOUSE_MASTER_RESEARCH = "com.metrogenesis.minecolonies.research.technology.warehousemaster.name";

    /**
     * Different setting possibilities.
     */
    public static final String PRIORITY  = "com.metrogenesis.minecolonies.core.crafting.setting.priority";
    public static final String MAX_STOCK = "com.metrogenesis.minecolonies.core.crafting.setting.maxstock";
