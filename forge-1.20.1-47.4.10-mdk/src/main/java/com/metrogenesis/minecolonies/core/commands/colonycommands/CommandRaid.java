...
import com.metrogenesis.minecolonies.core.commands.arguments.MultiColonyIdArgument;
import com.metrogenesis.minecolonies.core.commands.arguments.MultipleOptionsArgument;
...
import static com.metrogenesis.minecolonies.core.commands.CommandArgumentNames.*;
...
public class CommandRaid implements IMCOPCommand
{
    private static final DynamicCommandExceptionType ERROR_INVALID_COLONY_EVENT_TYPE =
        new DynamicCommandExceptionType(entry -> Component.translatable("com.metrogenesis.minecolonies.command.raid.colony_type.invalid", entry));
