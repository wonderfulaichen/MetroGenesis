...
import com.metrogenesis.minecolonies.api.blocks.AbstractBlockBarrel;
...
import com.metrogenesis.minecolonies.api.tileentities.AbstractTileEntityBarrel;
...
public class TileEntityBarrel extends AbstractTileEntityBarrel implements ITickable
{
    ...
    private void consumeNeededItems(final ItemStack itemStack, final CompostRecipe recipe)
    {
        ...
        //We update the quantities in the player麓s inventory and in the barrel
