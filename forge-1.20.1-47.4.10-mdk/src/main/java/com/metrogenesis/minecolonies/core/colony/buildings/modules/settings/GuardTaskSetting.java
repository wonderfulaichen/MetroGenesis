...
import static com.metrogenesis.minecolonies.core.colony.buildings.AbstractBuildingGuards.PATROL_MODE;
import static com.metrogenesis.minecolonies.core.colony.buildings.modules.settings.GuardPatrolModeSetting.MANUAL;
...
public class GuardTaskSetting extends StringSettingWithDesc
{
     ...
     */
    public static final String PATROL      = "com.metrogenesis.minecolonies.core.guard.setting.patrol";
    public static final String GUARD       = "com.metrogenesis.minecolonies.core.guard.setting.guard";
    public static final String FOLLOW      = "com.metrogenesis.minecolonies.core.guard.setting.follow";
    public static final String PATROL_MINE = "com.metrogenesis.minecolonies.core.guard.setting.patrol_mine";
    ...
    private void setPatrolMineHelpLabel(final ButtonImage button, final AbstractBuildingGuards.View building)
    {
        ...
        {
            component = Component.translatable("com.metrogenesis.minecolonies.coremod.gui.worherhuts.patrollingmine", building.getMinePos().toShortString());
        }
        else
        {
            component = Component.translatable("com.metrogenesis.minecolonies.coremod.job.guard.assignmine");
        }
