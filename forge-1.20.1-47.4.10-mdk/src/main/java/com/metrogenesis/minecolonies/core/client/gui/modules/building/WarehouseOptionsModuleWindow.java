...
import com.metrogenesis.minecolonies.core.colony.buildings.moduleviews.WarehouseOptionsModuleView;
...
import com.metrogenesis.minecolonies.core.network.messages.server.colony.building.MarkBuildingDirtyMessage;
...
import static com.metrogenesis.minecolonies.api.util.constant.TranslationConstants.LABEL_X_OF_Z;
import static com.metrogenesis.minecolonies.api.util.constant.TranslationConstants.WAREHOUSE_SORTED;
import static com.metrogenesis.minecolonies.api.util.constant.WindowConstants.*;
import static com.metrogenesis.minecolonies.core.client.gui.modules.building.WindowBuilderResModule.*;
    ...
    public void onOpened()
    {
        if (buildingView.getBuildingLevel() < BUILDING_LEVEL_FOR_SORTING)
        {
            ...
            PaneBuilders.tooltipBuilder()
                .append(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.warehouse.sort.disabled.1", BUILDING_LEVEL_FOR_SORTING))
                .appendNL(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.warehouse.sort.disabled.2", BUILDING_LEVEL_FOR_SORTING))
        ...
        switch (availability)
        {
            ...
            default:
                ...
                if (buildingView.getBuildingLevel() < buildingView.getBuildingMaxLevel())
                {
                    ...
                    PaneBuilders.tooltipBuilder()
                        .append(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.warehouse.upgrade.disabled.1", buildingView.getBuildingMaxLevel()))
                        .appendNL(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.warehouse.upgrade.disabled.2", buildingView.getBuildingMaxLevel()))
                        .hoverPane(addButton)
                        .build();
                }
                break;
