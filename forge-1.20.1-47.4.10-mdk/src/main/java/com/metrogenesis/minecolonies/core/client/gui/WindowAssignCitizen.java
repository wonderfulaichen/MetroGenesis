...
import com.metrogenesis.minecolonies.core.colony.buildings.moduleviews.LivingBuildingModuleView;
...
import static com.metrogenesis.minecolonies.api.util.constant.TranslationConstants.COM_MINECOLONIES_COREMOD_GUI_TOWNHALL_CITIZEN_UNEMPLOYED;
...
public class WindowAssignCitizen extends AbstractWindowSkeleton implements ButtonHandler
{
    ...
    {
        settingsButton.setText(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.hiringmode." + building.getHiringMode().name().toLowerCase(Locale.US)));
    }
    ...
    public void onOpened()
    {
        ...
        unassignedCitizenList.setDataProvider(new ScrollingList.DataProvider()
        {
            ...
            public void updateElement(final int index, @NotNull final Pane rowPane)
            {
                ...
                if (work != null)
                {
                    ...
                    workString = Component.translatable("com.metrogenesis.minecolonies.coremod.gui.home.new", newDistance);
                }

                MutableComponent homeString = Component.translatable("com.metrogenesis.minecolonies.coremod.gui.home.homeless");
                ...
                if (home != null)
                {
                    if (work != null)
                    {
                        ...
                        homeString = Component.translatable("com.metrogenesis.minecolonies.coremod.gui.home.currently", oldDistance);
                ...
                {
                    hireButton.disable();
                    PaneBuilders.tooltipBuilder().hoverPane(hireButton).build().setText(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.home.hire.warning"));
                }
            }
        });
        ...
        assignedCitizenList.setDataProvider(new ScrollingList.DataProvider()
        {
            ...
            public void updateElement(final int index, @NotNull final Pane rowPane)
            {
                ...
                final BlockPos work = citizen.getWorkBuilding();
                fireButton.setText(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.hiring.buttonunassign"));
                ...
                if (((!colony.getSettings().getSetting(BuildingTownHall.AUTO_HOUSING_MODE).getValue() && building.getHiringMode() == HiringMode.DEFAULT) || (building.getHiringMode() == HiringMode.MANUAL)))
                {
                    ...
                    {
                        fireButton.disable();
                        PaneBuilders.tooltipBuilder().hoverPane(fireButton).build().setText(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.home.travelling"));
                    }
                    else
                    {
                        fireButton.enable();
                ...
                {
                    fireButton.disable();
                    PaneBuilders.tooltipBuilder().hoverPane(fireButton).build().setText(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.home.hire.warning"));
                }
            }
        });
    }
