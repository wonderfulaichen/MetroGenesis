...
import com.metrogenesis.minecolonies.core.colony.buildings.workerbuildings.BuildingCowboy;
import com.metrogenesis.minecolonies.core.colony.jobs.JobCowboy;
...
import static com.metrogenesis.minecolonies.api.util.constant.StatisticsConstants.MILKING_ATTEMPTS;
import static com.metrogenesis.minecolonies.core.colony.buildings.workerbuildings.BuildingCowboy.MILKING_AMOUNT;
/**
...
public class EntityAIWorkCowboy extends AbstractEntityAIHerder<JobCowboy, BuildingCowboy>
{
    ...
    private final static VisibleCitizenStatus HERD_COW =
      new VisibleCitizenStatus(new ResourceLocation(Constants.MOD_ID, "textures/icons/work/cowboy.png"), "com.metrogenesis.minecolonies.gui.visiblestatus.cowboy");
