...
public class KillEntityObjectiveTemplateTemplate extends DialogueObjectiveTemplateTemplate implements IKillEntityObjectiveTemplate
{
    ...
    {
        final Component text = Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.kill", entityToKill.getDescription());
    ...
    public Component getProgressText(final IQuestInstance quest, final Style style)
    {
        ...
        {
            return Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.kill.progress",
