package com.metrogenesis.minecolonies.core.colony.eventhooks.citizenEvents;
...
import static com.metrogenesis.minecolonies.api.util.constant.NbtTagConstants.TAG_DEATH_CAUSE;
...
public class CitizenDiedEvent extends AbstractCitizenEvent
{
    ...
    {
        return "com.metrogenesis.minecolonies.core.event.summary.citizen.died";
    }
}
