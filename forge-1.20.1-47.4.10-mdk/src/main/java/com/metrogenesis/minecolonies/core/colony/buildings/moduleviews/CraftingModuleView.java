...
import com.metrogenesis.minecolonies.core.client.gui.modules.building.WindowListRecipes;
import com.metrogenesis.minecolonies.core.colony.buildings.views.AbstractBuildingView;
import com.metrogenesis.minecolonies.core.network.messages.server.colony.building.OpenCraftingGUIMessage;
...
public class CraftingModuleView extends AbstractBuildingModuleView
{
    ...
    {
        return Component.translatable("com.metrogenesis.minecolonies.coremod.gui.workerhuts.recipe." + id);
    }
