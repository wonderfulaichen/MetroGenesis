...
import static com.metrogenesis.minecolonies.api.util.constant.TranslationConstants.WARNING_DUPLICATE_TAVERN;

/**
 * HutBlock for the Tavern
 */
public class BlockHutTavern extends AbstractBlockHut<com.metrogenesis.minecolonies.core.blocks.huts.BlockHutTavern>
{
    /**
     * Block name
     */
