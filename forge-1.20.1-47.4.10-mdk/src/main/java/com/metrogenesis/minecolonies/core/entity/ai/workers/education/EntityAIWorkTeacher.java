package com.metrogenesis.minecolonies.core.entity.ai.workers.education;
...
import com.metrogenesis.minecolonies.core.colony.buildings.workerbuildings.BuildingSchool;
import com.metrogenesis.minecolonies.core.colony.jobs.JobPupil;
import com.metrogenesis.minecolonies.core.colony.jobs.JobTeacher;
...
import static com.metrogenesis.minecolonies.api.research.util.ResearchConstants.TEACHING;
...
import static com.metrogenesis.minecolonies.api.util.constant.StatisticsConstants.LESSONS_GIVEN;
...
public class EntityAIWorkTeacher extends AbstractEntityAIInteract<JobTeacher, BuildingSchool>
{
    ...
    private final static VisibleCitizenStatus TEACHING_ICON =
      new VisibleCitizenStatus(new ResourceLocation(Constants.MOD_ID, "textures/icons/work/teacher_student.png"), "com.metrogenesis.minecolonies.gui.visiblestatus.teacher_student");
