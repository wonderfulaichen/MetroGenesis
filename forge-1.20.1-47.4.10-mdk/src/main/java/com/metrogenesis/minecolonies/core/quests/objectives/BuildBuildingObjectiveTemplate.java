...
import com.metrogenesis.minecolonies.api.quests.IQuestDialogueAnswer;
import com.metrogenesis.minecolonies.api.quests.IQuestInstance;
import com.metrogenesis.minecolonies.api.quests.IQuestObjectiveTemplate;
import com.metrogenesis.minecolonies.core.colony.Colony;
import com.metrogenesis.minecolonies.core.event.QuestObjectiveEventHandler;
...
import static com.metrogenesis.minecolonies.api.quests.QuestParseConstant.*;
import static com.metrogenesis.minecolonies.api.util.constant.NbtTagConstants.TAG_QUANTITY;
...
public class BuildBuildingObjectiveTemplate extends DialogueObjectiveTemplateTemplate implements IBuildingUpgradeObjectiveTemplate
{
    ...
    private static DialogueElement buildDialogueTree(final BuildingEntry buildingEntry, final int qty, final int lvl, final boolean countExisting)
    {
        ...
        if (countExisting)
        {
            ...
            {
                text =
                  Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.buildbuilding.existing", lvl, qty, Component.translatable(buildingEntry.getTranslationKey()));
            }
            else
            {
                text = Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.buildbuilding.cumulative.existing",
                  lvl,
        ...
        else
        {
            if (qty > 0)
            {
                text = Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.buildbuilding", qty, lvl, Component.translatable(buildingEntry.getTranslationKey()));
            }
            else
            {
                text = Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.buildbuilding.cumulative", lvl, Component.translatable(buildingEntry.getTranslationKey()));
            }
        }

        final AnswerElement answer1 = new AnswerElement(Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.answer.later"),
          new IQuestDialogueAnswer.CloseUIDialogueAnswer());
        final AnswerElement answer2 = new AnswerElement(Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.answer.cancel"),
    ...
    public Component getProgressText(final IQuestInstance quest, final Style style)
    {
        if (quest.getCurrentObjectiveInstance() instanceof BuildingProgressInstance progress)
        {
            if (qty > 0)
            {
                return Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.buildbuilding.progress",
            ...
            {
                return Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.buildbuilding.progress.cumulative",
