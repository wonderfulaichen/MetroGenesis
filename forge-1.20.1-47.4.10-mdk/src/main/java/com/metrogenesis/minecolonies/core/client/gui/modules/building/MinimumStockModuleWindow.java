...
import com.metrogenesis.minecolonies.core.network.messages.server.colony.building.AddMinimumStockToBuildingModuleMessage;
import com.metrogenesis.minecolonies.core.network.messages.server.colony.building.RemoveMinimumStockFromBuildingModuleMessage;
    ...
    private void addStock()
    {
        if (!moduleView.hasReachedLimit())
        {
            new WindowSelectRes(this,
                ...
                true,
                Component.translatable("com.metrogenesis.minecolonies.coremod.gui.scan.select.stack")).open();
        }
    }
