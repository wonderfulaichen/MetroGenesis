...
import com.metrogenesis.minecolonies.core.network.messages.server.colony.HireMercenaryMessage;
import net.minecraft.client.Minecraft;
import net.minecraft.resources.ResourceLocation;
import net.minecraft.sounds.SoundEvents;
import org.jetbrains.annotations.NotNull;

import static com.metrogenesis.minecolonies.api.util.constant.WindowConstants.BUTTON_DONE;
