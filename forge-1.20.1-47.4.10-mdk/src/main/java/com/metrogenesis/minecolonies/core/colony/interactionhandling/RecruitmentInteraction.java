...
import static com.metrogenesis.minecolonies.api.util.constant.StatisticsConstants.VISITORS_ABSCONDED;
import static com.metrogenesis.minecolonies.api.util.constant.StatisticsConstants.VISITORS_RECRUITED;
import static com.metrogenesis.minecolonies.api.util.constant.TranslationConstants.*;
import static com.metrogenesis.minecolonies.api.util.constant.WindowConstants.CHAT_LABEL_ID;
import static com.metrogenesis.minecolonies.api.util.constant.WindowConstants.RESPONSE_BOX_ID;
import static com.metrogenesis.minecolonies.core.client.gui.WindowInteraction.BUTTON_RESPONSE_ID;
...
public class RecruitmentInteraction extends ServerCitizenInteraction
{
     ...
     * The recruit answer
     */
    private static final Tuple<Component, Component> recruitAnswer = new Tuple<>(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.chat.recruit"), null);

    @SuppressWarnings("unchecked")
    private static final Tuple<Component, Component>[] responses = (Tuple<Component, Component>[]) new Tuple[] {
      new Tuple<>(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.chat.showstats"), null),
      recruitAnswer,
      new Tuple<>(Component.translatable("com.metrogenesis.minecolonies.coremod.gui.chat.notnow"), null)};
        ...
        if (recruitButton != null && dataView instanceof IVisitorViewData visitorViewData)
        {
            ...
            window.findPaneOfTypeByID(CHAT_LABEL_ID, Text.class).setText(PaneBuilders.textBuilder()
                ...
                .appendNL(Component.translatable(
                    colony.getCitizens().size() < colony.getCitizenCountLimit() ? "com.metrogenesis.minecolonies.coremod.gui.chat.recruitcost"
                        : "com.metrogenesis.minecolonies.coremod.gui.chat.nospacerecruit",
