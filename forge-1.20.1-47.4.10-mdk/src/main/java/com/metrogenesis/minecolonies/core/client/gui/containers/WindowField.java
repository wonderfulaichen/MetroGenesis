package com.metrogenesis.minecolonies.core.client.gui.containers;
...
import com.metrogenesis.minecolonies.core.network.messages.server.colony.building.fields.FarmFieldPlotResizeMessage;
import com.metrogenesis.minecolonies.core.network.messages.server.colony.building.fields.FarmFieldUpdateSeedMessage;
...
import static com.metrogenesis.minecolonies.api.items.ModTags.cropBiomeTags;
import static com.metrogenesis.minecolonies.api.util.constant.TranslationConstants.*;
import static com.metrogenesis.minecolonies.api.util.constant.translation.GuiTranslationConstants.FIELD_GUI_ASSIGNED_FARMER;
import static com.metrogenesis.minecolonies.api.util.constant.translation.GuiTranslationConstants.FIELD_GUI_NO_ASSIGNED_FARMER;
import static com.metrogenesis.minecolonies.core.colony.buildingextensions.FarmField.MAX_RANGE;
...
public class WindowField extends AbstractWindowSkeleton
{
    ...
    public WindowField(@NotNull TileEntityScarecrow tileEntityScarecrow)
    {
        ...
        this.findPaneOfTypeByID("biome", Text.class)
            .setText(Component.translatable("com.metrogenesis.minecolonies.core.biome")
    ...
    private void selectSeed()
    {
        ...
        new WindowSelectRes(
            this,
            Component.translatable("com.metrogenesis.minecolonies.coremod.gui.field.selectseed"),
            farmField.getSeed(),
