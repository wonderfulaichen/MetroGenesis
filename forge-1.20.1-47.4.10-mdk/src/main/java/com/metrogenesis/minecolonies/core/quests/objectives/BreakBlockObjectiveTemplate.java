...
public class BreakBlockObjectiveTemplate extends DialogueObjectiveTemplateTemplate implements IBreakBlockObjectiveTemplate
{
    ...
    {
        final Component text = Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.breakblock", blockToMine.getName());
    ...
    public Component getProgressText(final IQuestInstance quest, final Style style)
    {
        ...
        {
            return Component.translatable("com.metrogenesis.minecolonies.coremod.questobjectives.breakblock.progress",
