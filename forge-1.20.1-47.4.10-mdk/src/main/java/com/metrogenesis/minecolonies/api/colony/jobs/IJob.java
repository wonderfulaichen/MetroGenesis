package com.metrogenesis.minecolonies.api.colony.jobs;
...
import static com.metrogenesis.minecolonies.api.util.constant.HappinessConstants.IDLE_AT_JOB_COMPLAINS_DAYS;
import static com.metrogenesis.minecolonies.api.util.constant.HappinessConstants.IDLE_AT_JOB_DEMANDS_DAYS;
...
public interface IJob<AI extends ITickingStateAI> extends INBTSerializable<CompoundTag>
{
     ...
     *
     * @return {@link com.metrogenesis.minecolonies.api.colony.IColony} of the citizen.
     */
    IColony getColony();
