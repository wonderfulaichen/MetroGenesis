...
/**
 * Defines a model type and its textures. Use the {@link com.metrogenesis.minecolonies.api.client.render.modeltype.registry.IModelTypeRegistry} to register it, together with a Citizen model for
