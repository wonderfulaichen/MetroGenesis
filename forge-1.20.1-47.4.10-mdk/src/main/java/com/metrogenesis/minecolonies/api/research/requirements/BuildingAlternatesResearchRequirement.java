...
import static com.metrogenesis.minecolonies.api.research.requirements.BuildingResearchRequirement.parseFallbackBuildingKey;
...
public class BuildingAlternatesResearchRequirement implements IResearchRequirement
{
    ...
    public MutableComponent getDesc()
    {
        ...
        while (iterator.hasNext())
        {
            ...
            requirementList.append(Component.translatable("com.metrogenesis.minecolonies.coremod.research.requirement.building.level", buildingName, buildingLevel));

            if (iterator.hasNext())
            {
                requirementList.append(Component.translatable("com.metrogenesis.minecolonies.coremod.research.requirement.building.or"));
            }
        }
