...
import com.metrogenesis.gui.MGStyles;
...
public abstract class MetroGenesisScreen<T extends AbstractContainerMenu> extends AbstractContainerScreen<T>
{
    ...
    protected static final int BG_COLOR = MGStyles.C_BG;        // v1.2 深色玻璃
    protected static final int BORDER_COLOR = MGStyles.C_BRASS;  // v1.2 黄铜细框
