...
import com.metrogenesis.blockui.controls.ToggleButton;
...
import com.metrogenesis.structurize.api.util.Shape;
...
import static com.metrogenesis.structurize.api.util.constant.Constants.BLUEPRINT_FOLDER;
import static com.metrogenesis.structurize.api.util.constant.Constants.SHAPES_FOLDER;
...
public class WindowShapeTool extends AbstractBlueprintManipulationWindow
{
    ...
    private class SectionDropDownList implements DropDownList.DataProvider
    {
        ...
        @Override
        public net.minecraft.network.chat.MutableComponent getLabel(final int index)
        {
            return net.minecraft.network.chat.Component.literal(sections.get(index));
        }
    }
