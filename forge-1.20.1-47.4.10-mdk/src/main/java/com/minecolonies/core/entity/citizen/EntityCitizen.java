...
public class EntityCitizen extends AbstractEntityCitizen implements IThreatTableEntity
{
    ...
    // 注释掉：Entity.remove(RemovalReason) 在 1.20.1 中是 final，不能 override
    // 改用 EntityLeaveWorldEvent 在 EventHandler 中处理
    // @Override
    ...
    // 注释掉：Entity.setRemoved(RemovalReason) 在 1.20.1 中是
